/* Identificar os jogadores mais indisciplinados com base na quantidade de cartões recebidos. */
...
cartoes_somados as (
    ...
    select
        ...
        coalesce(t1.atleta, t2.atleta) as Atleta,
